...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/minhon)](https://CRAN.R-project.org/package=minhon)
<!-- badges: end -->

R package to translate text(s) with [TexTra](https://mt-auto-minhon-mlt.ucri.jgn-x.jp/) WebAPI.
